...
export default function Admin() {
 ...
 const [bgColor, setBgColor] = useState("#DC9999")
    ...
    return(
        <div className="flex items-center flex-col min-h-screen pb-7 px-2" onSubmit={handleRegister}>
            ...
            <form className="flex flex-col mt-8 mb-3 w-full max-w-xl">
                ...
                <button type="submit" className="bg-blue-600 h-9 rounded-md text-white font-medium gap-4 felx justify-center items-center mb-7">
                  Cadastrar
                </button>

            </form>

            <h2 className="font-bold text-white mb-4 texte-2xl ">
              Meus links
            </h2>
